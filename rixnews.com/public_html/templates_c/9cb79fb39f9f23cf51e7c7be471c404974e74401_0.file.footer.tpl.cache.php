<?php
/* Smarty version 3.1.32, created on 2018-05-16 15:07:21
  from '/home/admin/web/cetnews.com/public_html/templates/footer.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5afc8f798d2324_74164475',
...
function content_5afc8f798d2324_74164475 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '2141976955afc8f798cf527_72318501';
?>
        <!-- Footer --> 
        <footer>
            <div class="container">
        ...
        <!-- jQuery JS -->
        <?php echo '<script'; ?>
 src="js/assets/vendor/jquery-1.12.4.min.js"><?php echo '</script'; ?>
>
        
        <!-- Poppers Js -->
        <?php echo '<script'; ?>
 src="js/assets/popper.js"><?php echo '</script'; ?>
>

        <!-- Bootstrap -->
        <?php echo '<script'; ?>
 src="js/assets/bootstrap.min.js"><?php echo '</script'; ?>
>
		
		<!-- Sticky Js -->
        <?php echo '<script'; ?>
 src="js/assets/jquery.sticky.js"><?php echo '</script'; ?>
>

        <!-- WOW JS -->
        <?php echo '<script'; ?>
 src="js/assets/wow.min.js"><?php echo '</script'; ?>
>

        <!-- Smooth Scroll -->
        <?php echo '<script'; ?>
 src="js/assets/smooth-scroll.js"><?php echo '</script'; ?>
>

        <!-- Mean Menu -->
        <?php echo '<script'; ?>
 src="js/assets/jquery.meanmenu.min.js"><?php echo '</script'; ?>
>

        <!-- News Ticker -->
        <?php echo '<script'; ?>
 src="js/assets/jquery.newsticker.min.js"><?php echo '</script'; ?>
>

        <!-- Owl Carousel -->
        <?php echo '<script'; ?>
 src="js/assets/owl.carousel.min.js"><?php echo '</script'; ?>
>

        <!-- Magnific Popup -->
        <?php echo '<script'; ?>
 src="js/assets/jquery.magnific-popup.min.js"><?php echo '</script'; ?>
>

        <!-- Syotimer -->
        <?php echo '<script'; ?>
 src="js/assets/jquery.syotimer.min.js"><?php echo '</script'; ?>
>
